...
function sendReg() {
  ...
  if (checkReg(usernameValue, emailValue, passwordValue, phoneValue, addressValue) == "OK") {
    const userObj = {
    ...
    notifyMsg.innerHTML = checkReg(usernameValue, emailValue, passwordValue, phoneValue, addressValue);
